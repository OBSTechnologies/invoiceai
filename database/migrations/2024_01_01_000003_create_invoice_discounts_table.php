...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $tableName = $prefix . config('invoiceai.tables.invoice_discounts', 'invoice_discounts');
    ...
    {
        $prefix = config('invoiceai.table_prefix', 'invoiceai_');
        Schema::dropIfExists($prefix . config('invoiceai.tables.invoice_discounts', 'invoice_discounts'));
    }
};
